...
public class CommitActivity extends BaseActivity{
    ...
    ,Activity27_2.class,Activity_boom.class,ActivitySdCardListFiles.class,ActivitySQLite01.class,Activity33.class,Activity35_1.class,Activity35_2.class,Activity36.class,ActivityGetTeacher_SQLite.class};
